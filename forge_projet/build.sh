...
cd src; cat data_equipment.js data_exercises.js data_pictos.js core.js engine.js ui_shell.js sfx.js fx.js timer.js charts.js trophies.js view_today.js view_history.js view_progress.js view_profil.js init.js; cd ..
