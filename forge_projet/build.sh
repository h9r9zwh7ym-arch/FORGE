...
cd src; cat data_equipment.js data_exercises.js core.js engine.js ui_shell.js timer.js charts.js trophies.js view_today.js view_history.js view_progress.js view_profil.js init.js; cd ..
